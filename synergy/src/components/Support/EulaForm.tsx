...
// lm_dfb73d82a2 also hosted on web
const eula = (
  <>
    ...
    <p>
      ...
      &quot;I Agree&quot; button, downloading or using Crylic.
    </p>
    ...
    <ul>
      <li>
        <p>
          <strong>Agreement</strong> means this End-User License Agreement that
      ...
      <li>
        <p>
          ...
          the Company downloaded by You to a Device, named Crylic
        </p>
      </li>
      <li>
        <p>
          ...
          this Agreement) refers to Crylic.
        </p>
      </li>
      <li>
        <p>
      ...
      <li>
        <p>
          <strong>Country</strong> refers to: New Hampshire, United States
        </p>
      </li>
      <li>
        <p>
      ...
      <li>
        <p>
          <strong>Third-Party Services</strong> means any services or content
      ...
      <li>
        <p>
          ...
          such individual is accessing or using the Application, as applicable.
        </p>
      </li>
    </ul>
    ...
    <p>
      ...
      to any third party claim arising out of or relating to the Application. To
      the extent the Company is required to provide indemnification by
      applicable law, the Company shall be solely responsible for the
    ...
    <p>
      The Company may from time to time provide enhancements or improvements to
      the features/functionality of the Application, which may include patches,
    ...
    <p>
      ...
      the Application. You agree that the Company has no obligation to (i)
    ...
    <p>
      ...
      deemed to constitute an integral part of the Application, and (ii) subject
      to the terms and conditions of this Agreement.
    </p>
    <h2>Maintenance and Support</h2>
    <p>
      The Company does not provide any maintenance or support for the download
      and use of the Application. To the extent that any maintenance or support
      is required by applicable law, the Company shall be obligated to furnish
      any such maintenance or support.
    </p>
    ...
    <p>
      ...
      any other aspect thereof. The Company does not assume and shall not have
    ...
    <p>
      ...
      of this Agreement or any law or regulation; or (c) violation of any right
      of a third party.
    </p>
    <h1>No Warranties</h1>
    <p>
      ...
      to the Application, including all implied warranties of merchantability,
    ...
    <p>
      ...
      Application, its servers, the content, or e-mails sent from or on behalf
    ...
    <p>
      ...
      amount actually paid by You for the Application or through the Application
      or 100 USD if You haven't purchased anything through the Application.
    </p>
    <p>
    ...
    <p>
      ...
      to the new terms, You are no longer authorized to use the Application.
    </p>
    <h1>Governing Law</h1>
    <p>
...
export function EulaForm({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="fixed w-screen h-screen bg-gray-700 p-8 flex flex-col items-end">
      <div className="flex-1 overflow-y-auto mb-4 p-8 bg-white eula-text">
        {eula}
      </div>
      <div className="btngrp-h">
        <button
          ...
          onClick={() =>
            enqueueSnackbar(
              "Accepting the End-User License Agreement is required to continue",
              {
                variant: "error",
              }
            )
        ...
        <button className="btn w-32" onClick={() => setAcceptedEula(true)}>
          I Agree
        </button>
      </div>
    </div>
